...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package exunit
    :bind (
           :map prog-mode-map
           ("C-z e u u" . 'exunit-verify-all)
           ("C-z e u f" . 'exunit-verify)
           ("C-z e u p" . 'exunit-verify-single)
           ("C-z e u r" . 'exunit-rerun)
           ("C-z e u t" . 'exunit-toggle-file-and-test)
           )
    :hook (
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package inf-elixir
    ...
    :bind (
           :map prog-mode-map
           ("C-z e i i" . 'inf-elixir)
           ("C-z e i p" . 'inf-elixir-project)
           ("C-z e i l" . 'inf-elixir-send-line)
           ("C-z e i r" . 'inf-elixir-send-region)
           ("C-z e i b" . 'inf-elixir-send-buffer)
           )
    )
